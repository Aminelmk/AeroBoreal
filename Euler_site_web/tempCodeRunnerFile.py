...
def create_surface_plot(variable, title, colorbar_title, x_2d, y_2d):
    ...
    fig.update_layout(
        ...
        scene=dict(
            ...
            camera=dict(eye=dict(x=0, y=0, z=0.06)),
            aspectmode='manual',
        ...
        dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Input(id='Mach', type='number', value=0.2, className="mb-2"),
                ], width=2),
                dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Input(id='k2', type='number', value=0.5, step=0.1, className="mb-2"),
                ], width=2),
                dbc.Col([
                    html.Label("k4 (4th Order Dissipation)"),
                    dcc.Input(id='k4', type='number', value=0.02, step=0.01, className="mb-2"),
                ], width=2),
            ], className="mb-3"),
...
def update_selected_graph(selected_graph, pathname):
    ...
    try:
        nx, ny, x_2d, y_2d = parse_mesh("x.9")
